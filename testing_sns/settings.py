"""
Django settings for testing_sns project.
...
SECRET_KEY = '+vc-o836-1igu@$eh2&+c$=m#0z_4*$wb@zp*%5sppanki*3t2'
...
WSGI_APPLICATION = 'testing_sns.wsgi.application'
